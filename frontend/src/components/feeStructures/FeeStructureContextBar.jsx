...
const FeeStructureContextBar = ({ currentAcademicYear, isLoading }) => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 text-xs sm:text-sm">
      ...
      <div className="flex items-center space-x-1.5 text-slate-500">
        ...
        <span className="text-slate-800 font-semibold">Fee Structures</span>
      </div>
...
export default FeeStructureContextBar;
